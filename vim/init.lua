...
-- Git
map('n', '<M-g>', ':w<cr>') -- Fzf list git status for all files
map('n', '<M-c>', ':w<cr>') -- Fzf list git commit for this buffer
map('n', '<M-C>', ':w<cr>') -- Fzf list git commit for entire repo
-- Buffer management
...
map('n', '<M-h>', ':TmuxNavigateLeft<cr>') -- Silent?
map('n', '<M-j>', ':TmuxNavigateDown<cr>') -- Silent?
map('n', '<M-k>', ':TmuxNavigateUp<cr>') -- Silent?
map('n', '<M-l>', ':TmuxNavigateRight<cr>') -- Silent?
-- Split window
