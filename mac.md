...
# Ask for the administrator password and keep the session alive until finish
sudo -v
...
# set date format: remember to use -dict style (see #expend the following panels for com.apple.finder below)
